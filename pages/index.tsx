...
const Home = (props: any) => {
  return (
        ...
        <button onClick={() => props.clear()}>Clear string</button>
			</div>
		</>
	)
}
...
const mapDispatchToProps = (dispatch: any) => ({
  ...
  randomizeElement: bindActionCreators(randomizeElement, dispatch),
  clear: bindActionCreators(clearElement, dispatch)
})
